/**
 * qrcode.js — vendored, not written here.
 *
 * QR Code Generator for JavaScript by Kazuhiko Arase, MIT licensed.
 * Source: https://www.npmjs.com/package/qrcode-generator (v2.0.4)
 *
 * Vendored because the Theme Store requires a QR code on the gift card page
 * (minimum 120 x 120px), and the only alternatives are worse: a data-URI service
 * would mean sending a redeemable gift card code to a third party's server, and
 * a hand-written encoder would mean betting a bearer instrument on getting
 * Reed-Solomon error correction and mask selection right.
 *
 * Loaded only by the gift card template, which a customer sees once.
 *
 * Do not edit. Replace wholesale when updating, and update LICENSE-qrcode.txt.
 */
