/**
 * lenis.js — vendored third-party dependency
 *
 * Lenis v1.3.25 — https://github.com/darkroomengineering/lenis
 * Copyright (c) 2024 darkroom.engineering
 * Released under the MIT License. Full licence text: LICENSE-lenis.txt
 *
 * Vendored rather than loaded from a CDN because the Shopify Theme Store
 * forbids external asset requests. Do not edit this file: replace it wholesale
 * when upgrading, and update the version recorded here and in release-notes.md.
 *
 * Consumed only by assets/scrollbar.js, through the `@theme/lenis` specifier.
 *
 * @module @theme/lenis
 */
